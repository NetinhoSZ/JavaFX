 ...
 * @author autologon
 */
public class FirstLesson extends javax.swing.JFrame {

    /**
     * Creates new form FirstLesson
     */
    public FirstLesson() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Barra de status...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FirstLesson.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FirstLesson().setVisible(true);
            }
        });
    }
